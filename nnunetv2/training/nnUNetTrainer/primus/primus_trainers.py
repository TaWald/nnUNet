...
from dynamic_network_architectures.architectures.primus import PrimusX, LayerNormNd, PrimusB, PrimusM, PrimusL, PrimusS
...
class nnUNet_Primus_S_Trainer(AbstractPrimus):
    ...
    def build_network_architecture(
        ...
        model = PrimusS(
            ...
            input_shape=self.configuration_manager.patch_size,
        )
        return model
...
class nnUNet_Primus_M_Trainer_150ep(nnUNet_Primus_M_Trainer):
    def __init__(
            self,
            plans: dict,
            configuration: str,
